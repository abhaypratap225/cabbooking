...
<!-- Navigation bar -->
    ...
    <h1 id="ces" style="margin-bottom: 80px;">All Available Cabs</h1>
  ...
  <thead class="table-dark">
    <tr>
      ...
      <th id="th" scope="col">Contact No.</th>
  ...
  <tbody class="table-light">
    ...
    $sql = "Select * from `cabs` where available='YES'";
    ...
    if($result)
    {
      while($row=mysqli_fetch_assoc($result))
      {
        ...
        echo '
          ...
          <td>'.$dname.'</td>
          <td>'.$cno.'</td>
          <td class="text-center"><a href="deletecab.php?deleteid='.$reg.'"><button class="cancel">Delete</button></a></td>
        </tr>';
      }
    }
      ?>

...
<!-- Navigation bar -->
    ...
    <h1 id="ces" style="margin-bottom: 80px;">All Booked Cabs</h1>
  ...
  <thead class="table-dark">
    <tr>
      ...
      <th id="th" scope="col">Booked By</th>
    ...
    if($result)
    {
      while($row=mysqli_fetch_assoc($result))
      {
        ...
        echo '
          ...
          <td>'.$pick.'</td>
          <td>'.$dr.'</td>
          <td class="text-center"><a href="admin_cancelbook.php?cancelid='.$reg.'"><button class="cancel">Cancel</button></a></td>
        </tr>';
      }
    }
      ?>
